package com.br.dentin.memoria.services;
...
public class MemoriaService extends Service implements SensorEventListener {
    ...
    private void initThread() {
        handlerThread = new HandlerThread(MemoriaService.class.getSimpleName());
        handlerThread.start();
    ...
    public class SensorBind extends Binder {
        private MemoriaService theService;
